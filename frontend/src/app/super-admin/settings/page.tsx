...
export default function SystemSettingsPage() {
  const [activeTab, setActiveTab] = useState<
    "general" | "security" | "maintenance" | "backups"
  >("maintenance");
  ...
  const [maintenance, setMaintenance] = useState<MaintenanceSettings>({
    ...
    maintenanceMessage:
      "EduTrac is currently undergoing scheduled platform upgrades.",
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">
            Configure platform-wide security policies, maintenance windows,
            database snapshots, and tenant isolation parameters.
          </p>
        </div>
        ...
        {activeTab === "general" && (
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setGeneral({
                      ...general,
                      maxFileUploadSizeMB: Number(e.target.value),
                    })
                  }
                  className="w-full p-2.5 border rounded-lg outline-none"
                />
            ...
            <div className="flex justify-end pt-2">
              <button className="px-4 py-2 bg-slate-900 text-white text-xs font-bold rounded-lg">
                Save Settings
              </button>
            </div>
          </div>
        ...
        {activeTab === "security" && (
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSecurity({
                      ...security,
                      failedLoginThreshold: Number(e.target.value),
                    })
                  }
                  className="w-full p-2.5 border rounded-lg outline-none"
                />
            ...
            <div className="flex items-center gap-2 pt-2">
              ...
              >
                Enforce Multi-Factor Authentication (MFA) for all Super Admin &
                School Admin users
              </label>
            </div>
            <div className="flex justify-end pt-2">
