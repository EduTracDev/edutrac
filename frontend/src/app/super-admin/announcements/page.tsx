...
const INITIAL_ANNOUNCEMENTS: AnnouncementFormData[] = [
  {
    ...
    content:
      "We have deployed new grading features and enhanced report card templates.",
    priority: "Normal",
    targetType: "All",
    selectedSchoolIds: [],
  ...
  },
  {
    ...
    content:
      "Platform will undergo routine maintenance on Sunday from 2 AM to 4 AM UTC.",
    priority: "Urgent",
    targetType: "All",
    selectedSchoolIds: [],
...
export default function AnnouncementsPage() {
  const [announcements, setAnnouncements] = useState<AnnouncementFormData[]>(
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-slate-500">
              Broadcast platform updates, alerts, and notices across EduTrac
              schools.
            </p>
          </div>
          <button
                ...
                <div className="pt-3 border-t border-slate-100 flex justify-between items-center text-xs text-slate-400">
                  <div className="flex gap-4">
                    <span>
                      ...
                      {item.targetType === "All"
                        ? "All Schools"
                        : `${item.selectedSchoolIds.length} Schools`}
                    </span>
