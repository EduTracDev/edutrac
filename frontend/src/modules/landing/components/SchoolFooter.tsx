...
export const SchoolFooter = ({ logoUrl, schoolName, address, footerTitle }: SchoolFooterProps) => {
    return (
        <footer className="bg-[#F8F6F9] pt-20 pb-10 px-6">
            ...
            <div className="max-w-6xl mx-auto pt-2 border-t border-[#DCDCDC] text-center text-xs font-normal text-slate-400">
                {address && (
                        <p className="text-sm text-slate-500 font-semibold leading-relaxed text-center">
                            {address}
                        </p>
                    )}
