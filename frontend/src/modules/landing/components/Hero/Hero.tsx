    ...
    <section className="w-full overflow-hidden">
      ...
      <div className="relative w-full pt-32 pb-20 bg-white">
        <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
          <img src="./hero-background.png" alt="hero-background" className="absolute bottom-0 left-0 w-full min-w-[1440px] h-auto opacity-90 text-[#923CF9]/10"  />
        </div>
            ...
            <div className="space-y-3">
              ...
              <h2 className="font-epilogue text-3xl sm:text-4xl font-extrabold text-[#0A1128] max-w-2xl mx-auto leading-snug">
                ...
                <span className="relative inline-block z-10 px-1">
                  Education
                  <img src="/underline.svg" alt="underline" width={127} height={49} className="absolute left-0 bottom-0 object-contain text-[#923CF9]/40 -z-10" />
                </span>{" "}
                Management Solution.
              </h2>
            </div>
